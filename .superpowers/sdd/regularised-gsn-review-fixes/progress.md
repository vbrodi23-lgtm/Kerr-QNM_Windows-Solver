# SDD ledger — plan: /tmp/regularised-gsn-review-fixes.md

- Task 1: committed `3aee58d` — raw horizon diagnostic no longer blocks a safe normalised chart; raw evidence is explicitly available, unavailable-overflow, or not-applicable.
- Task 2: committed `7740221` — schema-aware conditioning acceptance, cache-hit failed-preflight predecessor materialization, and durable 120-digit asymptotic containment.
